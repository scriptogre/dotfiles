...
nixpkgs.lib.nixosSystem {
  system = "x86_64-linux";
  modules = [
    # Hardware configuration will need to be added when deploying
    ({ pkgs, ... }: {
      ...
      systemd.services.tailscale-up = {
        ...
        serviceConfig = {
          Type = "oneshot";
          RemainAfterExit = "yes";
          ExecStart = "${pkgs.lib.getBin pkgs.tailscale}/bin/tailscale up --accept-dns=false --advertise-routes=192.168.1.0/24 --ssh";
        };
      };
